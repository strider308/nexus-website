  ...
  return (
    <footer className="w-full bg-black border-t border-[#DEDBC8]/10 text-gray-400 py-16 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 flex flex-col items-center text-center relative z-10">
        ...
        <p className="text-xs text-gray-500 font-light mb-8 max-w-sm leading-relaxed">
          Custom software and automation for complex workflows.
        </p>

        {/* Page Links */}
        <div className="flex flex-wrap gap-6 justify-center mb-8 text-[10px] font-mono font-bold uppercase tracking-wider">
        ...
        {/* Social Links */}
        <div className="flex gap-6 justify-center mb-8 text-[10px] font-mono font-bold uppercase tracking-wider">
          <a
        ...
        {/* Metadata and Legal */}
        <div className="flex flex-col md:flex-row gap-4 items-center justify-between w-full max-w-4xl text-[10px] text-gray-500 font-mono font-bold">
          <div>
