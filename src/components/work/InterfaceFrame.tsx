        ...
        case "reception_setup":
          return (
            <svg viewBox="0 0 800 360" className="w-full bg-[#070707] font-mono text-[10px] fill-[#dedbc8]">
              ...
              <text x="20" y="25" className="font-bold fill-[#2a7d8a] text-[13px]">CLINICOS // PATIENT REGISTRATION MANAGER</text>
              <text x="780" y="25" className="fill-gray-500 text-right text-[11px]" textAnchor="end">REG-DESK // CLIENT INDEX</text>
              ...
              <text x="32" y="80" className="font-bold fill-gray-400 text-[11px]">INDEX MATCH FINDER</text>
              <rect x="32" y="92" width="196" height="28" fill="rgba(222,219,200,0.03)" stroke="rgba(222,219,200,0.2)" />
              <text x="42" y="110" className="fill-[#dedbc8] text-[11px]">+91 98450 12845</text>
              <rect x="32" y="136" width="196" height="188" fill="rgba(42,125,138,0.03)" stroke="rgba(42,125,138,0.3)" />
              <text x="42" y="156" className="font-bold fill-[#2a7d8a] text-[11px]">FAMILY LEDGER // #FM-4028</text>
              <text x="42" y="180" className="fill-[#dedbc8] font-bold text-[11px]">Primary: Ramesh Nair (54 M)</text>
              <text x="42" y="194" className="fill-gray-400 text-[10px]">BP: 138/88 // Verified</text>
              <line x1="42" y1="208" x2="218" y2="208" stroke="rgba(42,125,138,0.2)" />
              <text x="42" y="226" className="fill-[#dedbc8] text-[11px]">Member 2: Anita Nair (48 F)</text>
              <text x="42" y="240" className="fill-gray-400 text-[10px]">Diabetic Review // Arrived</text>
              ...
              <text x="280" y="80" className="font-bold fill-gray-400 text-[11px]">CREATE PROFILE REGISTRY</text>
        ...
        case "guest_menu":
          return (
            <svg viewBox="0 0 800 360" className="w-full bg-[#070707] font-mono text-[10px] fill-[#dedbc8]">
              ...
              <text x="20" y="25" className="font-bold fill-[#c87b3a] text-[13px]">RESTAURANTOS // TABLE GUEST PORTAL</text>
              <text x="780" y="25" className="fill-gray-500 text-right text-[11px]" textAnchor="end">TABLE 04 // ORDER TAB</text>
              <line x1="0" y1="40" x2="800" y2="40" stroke="rgba(222,219,200,0.14)" />
              <rect x="20" y="60" width="500" height="280" fill="none" stroke="rgba(222,219,200,0.1)" />
              <text x="32" y="80" className="font-bold fill-[#c87b3a] text-[11px]">APPETIZERS MENU</text>
              <rect x="32" y="95" width="456" height="50" fill="rgba(222,219,200,0.02)" stroke="rgba(222,219,200,0.1)" />
              <text x="42" y="115" className="fill-white font-bold text-[11px]">Paneer Tikka (Plate) &mdash;&mdash;&mdash;&mdash;&mdash;&mdash;&mdash;&mdash;&mdash;&mdash; $12.50</text>
              <text x="42" y="130" className="fill-gray-400 text-[10px]">Allergen: Dairy. Grilled Indian cottage cheese with mint dip.</text>
              <rect x="440" y="105" width="40" height="18" fill="#c87b3a" />
              <text x="460" y="117" className="fill-[#070707] font-bold text-[11px] text-center" textAnchor="middle">ADD</text>
            </svg>
          );
        ...
        case "workspace_overview":
          return (
            <svg viewBox="0 0 800 360" className="w-full bg-[#070707] font-mono text-[10px] fill-[#dedbc8]">
              ...
              <text x="20" y="25" className="font-bold fill-[#8b7bc4] text-[13px]">SHIPWRIGHT // WORKSPACE DIRECTORY</text>
              <text x="780" y="25" className="fill-gray-500 text-right text-[11px]" textAnchor="end">WORKSPACE: METADATA</text>
              <line x1="0" y1="40" x2="800" y2="40" stroke="rgba(222,219,200,0.14)" />
              <rect x="20" y="60" width="760" height="280" fill="none" stroke="rgba(222,219,200,0.1)" />
              <text x="32" y="80" className="font-bold fill-[#8b7bc4] text-[11px]">ACTIVE PROJECTS MATRIX</text>
              <rect x="32" y="95" width="716" height="50" fill="rgba(222,219,200,0.02)" stroke="rgba(222,219,200,0.1)" />
              <text x="42" y="115" className="fill-white font-bold text-[11px]">Project A: waitlist portal &mdash; 77% complete</text>
              <text x="42" y="130" className="fill-gray-400 text-[10px]">Milestone rollout: Beta Waitlist System Rollout &mdash; Tasks: 18 Shipped</text>
            </svg>
          );
        ...
        case "bp_chart":
          return (
            <svg viewBox="0 0 800 360" className="w-full bg-[#070707] font-mono text-[10px] fill-[#dedbc8]">
              ...
              <text x="20" y="25" className="font-bold fill-white text-[13px]">AAROGYA // PERSONAL BP TREND CHART</text>
              <line x1="0" y1="40" x2="800" y2="40" stroke="rgba(222,219,200,0.14)" />
              ...
              <text x="560" y="113" className="fill-white font-bold text-[11px]">120/78 (Resting)</text>
              <text x="50" y="280" className="fill-gray-500 text-[10px]">Local device indicators verify a 14-day stable resting period.</text>
            </svg>
          );
        case "med_routine":
          return (
        ...
        case "vulnerability_card":
          return (
            <svg viewBox="0 0 800 360" className="w-full bg-[#070707] font-mono text-[10px] fill-[#dedbc8]">
              ...
              <text x="20" y="25" className="font-bold fill-white text-[13px]">SECURESCAN // THREAT REMEDIATION CARD</text>
              <line x1="0" y1="40" x2="800" y2="40" stroke="rgba(222,219,200,0.14)" />
              <rect x="50" y="80" width="700" height="220" fill="rgba(196,74,122,0.05)" stroke="#c44a7a" strokeWidth="1.5" />
              <text x="70" y="110" className="fill-[#c44a7a] font-bold text-[13px]">VULNERABILITY DETECTED // SQL INJECTION</text>
              <text x="70" y="140" className="fill-white text-[11px]">File: src/controllers/search.ts:24</text>
              <text x="70" y="160" className="fill-gray-400 text-[10px]">Parameter &apos;q&apos; is concatenated directly into query builder statement.</text>
              <text x="70" y="180" className="fill-gray-500 text-[10px]">Payload: search?q=admin%27%20OR%201=1--</text>
              <text x="70" y="210" className="fill-green-400 font-bold text-[11px]">Suggested Fix: Use parameterized inputs with knex client bindings.</text>
            </svg>
          );
        case "scan_history":
          return (
        ...
        case "safety_plan":
          return (
            <svg viewBox="0 0 800 360" className="w-full bg-[#070707] font-mono text-[10px] fill-[#dedbc8]">
              ...
              <text x="20" y="25" className="font-bold fill-white text-[13px]">SAFEDATE // SAFETY CHECK-IN PLAN</text>
              <line x1="0" y1="40" x2="800" y2="40" stroke="rgba(222,219,200,0.14)" />
              <text x="50" y="80" className="fill-white font-bold text-[11px]">PLAN LOGS</text>
              <text x="50" y="110" className="fill-gray-300 text-[11px]">Venue: Blue Tokai Cafe, Connaught Place</text>
              <text x="50" y="130" className="fill-gray-300 text-[10px]">Check-in timer scheduled: 19:30 (Grace limit: 15 mins)</text>
              <text x="50" y="150" className="fill-gray-400 text-[10px]">Contacts assigned: Friend Amit (+91 98450 49201)</text>
            </svg>
          );
        case "timer_prompt":
          return (
        ...
        case "public_roadmap":
          return (
            <svg viewBox="0 0 800 360" className="w-full bg-[#070707] font-mono text-[10px] fill-[#dedbc8]">
              ...
              <text x="20" y="25" className="font-bold fill-[#dedbc8] text-[13px]">BUILDPUBLIC // ROADMAP DASHBOARD</text>
              <line x1="0" y1="40" x2="800" y2="40" stroke="rgba(222,219,200,0.14)" />
              <text x="50" y="80" className="fill-[#dedbc8] font-bold text-[11px]">PUBLIC TIMELINE</text>
              <text x="50" y="110" className="fill-white font-bold text-[11px]">&bull; waitlist landing page live &mdash; Dec 12</text>
              <text x="50" y="130" className="fill-gray-400 text-[10px]">&bull; private beta launch scheduled &mdash; Dec 18</text>
            </svg>
          );
        case "task_planner":
          return (
