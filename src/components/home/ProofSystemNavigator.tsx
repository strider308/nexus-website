        ...
        {projects.map((project, idx) => {
          ...
          return (
            <button
              ...
              className={`text-left p-3.5 border transition-[color,background-color,border-color] duration-[var(--motion-duration-control)] ease-[var(--motion-ease-out)] outline-none focus:ring-1 focus:ring-[#dedbc8] ${
                isActive
                  ? "border-[#dedbc8] bg-[#0d0d0d] text-[#dedbc8]"
