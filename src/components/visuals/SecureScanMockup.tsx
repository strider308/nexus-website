...
export function SecureScanMockup() {
  return (
    <svg viewBox="0 0 800 340" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="SecureScan interface preview" className="w-full block select-none">
      ...
      <text x="104" y="193" font-family="sans-serif" font-size="10" fill="#6B6B6B">Parameter &apos;q&apos; is vulnerable in query builder</text>
      ...
      <text x="60" y="234" font-family="sans-serif" font-size="9" font-weight="700" fill="white" text-anchor="middle">HIGH</text>
      <text x="86" y="229" font-family="sans-serif" font-size="11" font-weight="600" fill="#1A2B4C">Expired SSL Certificate</text>
      <text x="86" y="245" font-family="sans-serif" font-size="10" fill="#6B6B6B">Staging domain certificate expires in 3 days</text>
 
      <rect x="28" y="266" width="356" height="52" rx="5" fill="white" stroke="#E5E8ED" stroke-width="0.5"/>
      <rect x="28" y="266" width="4" height="52" rx="2" fill="#D4AC0D"/>
      <rect x="42" y="274" width="44" height="16" rx="3" fill="#D4AC0D"/>
      <text x="64" y="286" font-family="sans-serif" font-size="9" font-weight="700" fill="white" text-anchor="middle">MEDIUM</text>
      <text x="94" y="281" font-family="sans-serif" font-size="11" font-weight="600" fill="#1A2B4C">Missing security headers</text>
      <text x="94" y="297" font-family="sans-serif" font-size="9" fill="#6B6B6B">X-Frame-Options, CSP header not fully configured</text>
      <text x="94" y="309" font-family="sans-serif" font-size="9" fill="#6B6B6B">on production API Gateway endpoints</text>
 
      {/* Code snippet details */}
      <rect x="412" y="132" width="372" height="196" rx="8" fill="white" stroke="#E5E8ED" stroke-width="0.5"/>
      ...
      <text x="428" y="154" font-family="sans-serif" font-size="11" font-weight="700" fill="#1A2B4C">Vulnerable Code — search.ts:24</text>
      
      <rect x="424" y="178" width="348" height="136" rx="4" fill="#1E293B"/>
      <text x="436" y="196" font-family="monospace" font-size="10" fill="#94A3B8">22 |  const query = req.query.q;</text>
      <text x="436" y="212" font-family="monospace" font-size="10" fill="#EF4444">23 |  const sql = `SELECT * FROM items` + </text>
      <text x="436" y="228" font-family="monospace" font-size="10" fill="#EF4444">24 |              `WHERE name LIKE &apos;%{"${query}"}%&apos;`;</text>
      <text x="436" y="244" font-family="monospace" font-size="10" fill="#F59E0B">25 |  // TODO: sanitize input parameters</text>
      <text x="436" y="260" font-family="monospace" font-size="10" fill="#94A3B8">26 |  const result = await db.execute(sql);</text>
      <text x="436" y="276" font-family="monospace" font-size="10" fill="#94A3B8">27 |  return res.json(result);</text>
    </svg>
  );
}
