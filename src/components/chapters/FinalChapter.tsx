    ...
    >
      ...
      >
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4">
          ...
          <a
            href="/services"
            className="border border-[#dedbc8]/20 px-8 py-4 text-xs font-mono font-bold uppercase text-[#dedbc8] hover:border-[#dedbc8] transition-all duration-300 text-center"
          >
