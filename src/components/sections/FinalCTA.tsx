      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="relative border border-[#DEDBC8]/10 rounded-[2rem] bg-[#101010] p-8 md:p-16 text-center overflow-hidden shadow-lg shadow-black/40">
          ...
          <div className="relative z-10 max-w-2xl mx-auto flex flex-col items-center">
            <span className="text-[9px] font-mono text-gray-500 uppercase tracking-widest mb-4">
              Scoping Intake
            </span>
            ...
            <div className="flex flex-col sm:flex-row gap-3.5 justify-center w-full max-w-sm">
              ...
              <a 
                ...
                className="group flex items-center justify-between gap-4 bg-[#DEDBC8] hover:bg-[#DEDBC8]/90 text-black rounded-full pl-5 pr-1.5 py-1.5 w-full text-xs font-semibold tracking-wider uppercase transition-all duration-300 outline-none"
              >
              ...
              <Link 
                href="/demo"
                className="flex items-center justify-center border border-[#DEDBC8]/25 text-[#DEDBC8] hover:bg-[#DEDBC8]/10 hover:border-[#DEDBC8]/40 rounded-full px-5 py-3 w-full text-xs font-semibold tracking-wider uppercase transition-all duration-300 outline-none text-center"
              >
                View demo library
              </Link>
            </div>
